...
import 'merchandiser_details_page.dart';
...
class _ClubsPageState extends State<ClubsPage> {
  ...
  void _navigateToClubDetails(BuildContext context, ClubData club) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => MerchandiserDetailsPage(
          merchandise: _convertClubToMerchandise(club),
        ),
      ),
    );
  }

  MerchandiseData _convertClubToMerchandise(ClubData club) {
    return MerchandiseData(
      name: club.name,
      rating: club.rating,
      location: club.location,
      categories: club.availableSports,
      price: 50, // Default price
      stock: 25, // Default stock count
...
// Data model for merchandise information
