...
class _SubscriptionsTabState extends State<SubscriptionsTab> {
  ...
  final Map<String, String> _unpaidServiceDescriptions = {
    ...
    'Slack (Automatic Mobile Notifications)':
        'Receive automatic notifications on mobile',
  };
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.payment, color: widget.roleColor, size: 20),
              ),
              const SizedBox(width: 12),
              Text(
                'Payment Details',
          ...
          const SizedBox(height: 16),
          _buildReadOnlyField('Payment Time', _paymentTime.format(context)),
        ],
      ),
    );
  }
