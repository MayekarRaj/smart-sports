...
class _MerchandiserProfilePlaceholder extends StatelessWidget {
  final String title;
  const _MerchandiserProfilePlaceholder({required this.title});
...
class _StoresTab extends StatelessWidget {
  final bool isWide;
  const _StoresTab({required this.isWide});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            TextFormField(
              decoration: const InputDecoration(labelText: 'Number of Stores'),
            ),
            const SizedBox(height: 24),
            SizedBox(
