    ...
    switch (index) {
      ...
      case 2:
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (_) =>
                const _MerchandiserSupportPlaceholder(title: 'Inventory'),
          ),
        );
        break;
      case 3:
...
class _MerchandiserSupportPlaceholder extends StatelessWidget {
  final String title;

  const _MerchandiserSupportPlaceholder({required this.title});
