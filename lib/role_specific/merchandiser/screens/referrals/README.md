# Coach Referral Management - Mobile-First Design

## Overview
A mobile-first Flutter UI for coach referral management, inspired by modern web design patterns but optimized for mobile devices. Features comprehensive filtering, search functionality, and an invite referral system.
...
```
lib/role_specific/coach/screens/referrals/
├── coach_referrals_page.dart      # Main mobile-first referrals page
...
### Navigation
```dart
// Navigate to coach referrals page
Navigator.pushNamed(context, '/coach-referrals');
```
