...
class _ViewUserScreenState extends State<ViewUserScreen>
  ...
  void initState() {
    super.initState();
    print(
      'Merchandiser ViewUserScreen initState called with userData: ${widget.userData}',
    );
  ...
  Widget build(BuildContext context) {
    print('Merchandiser ViewUserScreen build method called');
    return Scaffold(
    ...
    final employees = [
      {
        ...
        'role': 'Sales Manager',
        'department': 'Sales',
        'email': 'mark.thompson@merchandise.com',
      ...
      },
      {
        ...
        'department': 'Product',
        'email': 'jennifer.lee@merchandise.com',
      ...
      },
      {
        ...
        'email': 'robert.chen@merchandise.com',
      ...
      },
      {
        ...
        'email': 'amanda.wilson@merchandise.com',
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              height: 50,
              decoration: BoxDecoration(
                color: isActive ? const Color(0xFF009A69) : Colors.grey[400],
                shape: BoxShape.circle,
              ),
              child: Center(
                child: Text(
