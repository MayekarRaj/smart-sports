# Coach Users Management - Mobile-First Design

## Overview
A mobile-first Flutter UI for coach user management, inspired by modern web design patterns but optimized for mobile devices. Features pill-style tabs, collapsible filters, and card-based user display.
...
```
lib/role_specific/coach/screens/users/
├── coach_users_page.dart      # Main mobile-first users page
...
### Navigation
```dart
// Navigate to coach users page
Navigator.pushNamed(context, '/coach-users');
