...
class MerchandiserAnalyticsDashboardPage extends StatefulWidget {
  const MerchandiserAnalyticsDashboardPage({super.key});

  @override
  State<MerchandiserAnalyticsDashboardPage> createState() =>
      _MerchandiserAnalyticsDashboardPageState();
}
...
class _MerchandiserAnalyticsDashboardPageState
    extends State<MerchandiserAnalyticsDashboardPage>
    ...
    return Material(
      ...
      child: Container(
        ...
        child: TabBar(
          ...
          isScrollable: true,
          labelColor: const Color(0xFF009A69), // Merchandiser green theme
