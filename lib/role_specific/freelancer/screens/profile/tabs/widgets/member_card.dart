...
import 'package:smart_sports/shared/widgets/profile_tabs/widgets/practice_plan_card.dart';
...
class _MemberCardState extends State<MemberCard> {
  ...
  void _initializeControllers() {
    ...
    _contactController.text = _member['contactNumber']?.toString().replaceAll('+1-', '') ?? '';
  ...
  void _updateMember() {
    ...
    _member['contactNumber'] = '${_member['countryCode']}-${_contactController.text}';
    _member['address'] = {
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    widget.isHead ? 'Member 1 (Head)' : 'Member ${_member['id'] + 1}',
                    style: TextStyle(
                      fontSize: 18,
  ...
  Widget _buildSportsInterestedSection() {
    final selectedSports = (_member['sportsInterested'] as List<dynamic>?)
            ?.map((e) => e.toString())
            .toList() ??
        <String>[];
          ...
          children: _availableSports.map((sport) {
            ...
            return FilterChip(
              ...
              labelStyle: TextStyle(
                color: isSelected ? widget.roleColor : Colors.grey.shade700,
                fontWeight: isSelected ? FontWeight.w600 : FontWeight.w500,
              ),
              side: BorderSide(
                color: isSelected ? widget.roleColor : Colors.grey.shade300,
            ...
            children: [
              ...
              Expanded(
                child: _buildDropdownField(
                  ...
                  items: const ['United States', 'Canada', 'United Kingdom', 'Australia'],
                  onChanged: (value) {
                    setState(() {
                      _member['address'] ??= {};
  ...
  Widget _buildPracticePlanSection() {
    final practicePlanSameAsMain = _member['practicePlanSameAsMain'] as bool? ?? true;
  ...
  Widget _buildPreferredClubsSection() {
    final preferredClubsSameAsMain = _member['preferredClubsSameAsMain'] as bool? ?? true;
    final selectedClubs = (_member['preferredClubs'] as List<dynamic>?)
            ?.map((e) => e.toString())
            .toList() ??
        <String>[];
