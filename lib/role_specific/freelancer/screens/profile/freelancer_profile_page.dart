...
class _FreelancerProfilePageState extends State<FreelancerProfilePage>
  ...
  final Color _roleColor = const Color(0xFFEF4444); // Red for Freelancer

  // Form controllers
  final _firstNameController = TextEditingController(text: 'David');
  final _lastNameController = TextEditingController(text: 'Wilson');
  final _passwordController = TextEditingController();
  final _addressLine1Controller = TextEditingController(text: '654 Creative Street');
  final _addressLine2Controller = TextEditingController(text: 'Studio 3');
  final _cityController = TextEditingController(text: 'Austin');
  final _pincodeController = TextEditingController(text: '78701');
  final _companyNameController = TextEditingController(text: 'Independent Freelancer');
  final _designationController = TextEditingController(text: 'Freelance Professional');
  final _departmentController = TextEditingController(text: 'Creative Services');
  ...
  final _websiteController = TextEditingController(text: 'www.davidwilson.com');
