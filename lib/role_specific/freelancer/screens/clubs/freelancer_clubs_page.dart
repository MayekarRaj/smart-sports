...
import 'freelancer_club_details_page.dart';

class FreelancerClubsPage extends StatefulWidget {
  const FreelancerClubsPage({super.key});

  @override
  State<FreelancerClubsPage> createState() => _FreelancerClubsPageState();
}

class _FreelancerClubsPageState extends State<FreelancerClubsPage> {
  ...
  List<ClubData> get _filteredClubs {
    List<ClubData> clubs = _selectedTabIndex == 0
        ? _allClubs
  ...
  void _navigateToClubDetails(BuildContext context, ClubData club) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => FreelancerClubDetailsPage(club: club),
      ),
    );
  }
