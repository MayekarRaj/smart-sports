...
/// CoachPhoneFilters: unified, phone-style filter section for Coach screens
/// - Uses coach green background (#059669)
/// - Mobile-friendly stacked layout
/// - Optional header toggle; can be embedded without header
class CoachPhoneFilters extends StatefulWidget {
  ...
  @override
  State<CoachPhoneFilters> createState() => _CoachPhoneFiltersState();
}

class _CoachPhoneFiltersState extends State<CoachPhoneFilters>
  ...
  Widget build(BuildContext context) {
    final Color bg = const Color(0xFF059669);
