...
class _CoachCustomerSupportPageState extends State<CoachCustomerSupportPage> {
  ...
  final List<Complaint> _complaints = [
    Complaint(
      title: 'Training Session Issue',
      category: 'Training',
      description: 'Player reported issues with training schedule.',
      complaintFrom: 'Player',
      date: '2025-04-10',
      status: 'Open',
    ),
    Complaint(
      ...
      category: 'Equipment',
      description: 'Court equipment malfunction during practice.',
