...
class CoachUsersPage extends ConsumerStatefulWidget {
  const CoachUsersPage({super.key});

  @override
  ConsumerState<CoachUsersPage> createState() => _CoachUsersPageState();
}

class _CoachUsersPageState extends ConsumerState<CoachUsersPage>
