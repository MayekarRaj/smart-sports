...
class _CoachProfilePageState extends State<CoachProfilePage>
  ...
  final Color _roleColor = const Color(0xFF10B981); // Green for Coach
  ...
  final _addressLine1Controller = TextEditingController(text: '456 Oak Avenue');
  final _addressLine2Controller = TextEditingController(text: 'Suite 200');
  final _cityController = TextEditingController(text: 'Los Angeles');
  final _pincodeController = TextEditingController(text: '90001');
  final _companyNameController = TextEditingController(
    text: 'Elite Sports Academy',
  );
  final _designationController = TextEditingController(text: 'Head Coach');
  final _departmentController = TextEditingController(text: 'Training');
  ...
  final _websiteController = TextEditingController(text: 'www.elitesports.com');
