...
/// CorporatePhoneFilters: unified, phone-style filter section for Corporate screens
/// - Uses corporate gradient background (#232534 to #414384)
/// - Mobile-friendly stacked layout
/// - Optional header toggle; can be embedded without header
class CorporatePhoneFilters extends StatefulWidget {
  ...
  @override
  State<CorporatePhoneFilters> createState() => _CorporatePhoneFiltersState();
}

class _CorporatePhoneFiltersState extends State<CorporatePhoneFilters>
  ...
  Widget build(BuildContext context) {
    final Color bg = const Color(0xFF232534);
