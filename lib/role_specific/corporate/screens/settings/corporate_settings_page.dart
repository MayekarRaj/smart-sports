...
class CorporateSettingsPage extends ConsumerStatefulWidget {
  const CorporateSettingsPage({super.key});

  @override
  ConsumerState<CorporateSettingsPage> createState() => _CorporateSettingsPageState();
}

class _CorporateSettingsPageState extends ConsumerState<CorporateSettingsPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF1E40AF), // Corporate blue
        elevation: 0,
        centerTitle: true,
        leading: Builder(
        ...
        builder: (context, constraints) {
          if (constraints.maxWidth < 768) {
            ...
            return Column(
              children: [
                Container(
                  color: const Color(0xFF1E40AF), // Corporate blue
                  child: TabBar(
