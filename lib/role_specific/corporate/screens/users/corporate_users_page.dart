  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF059669), // Corporate green
        elevation: 0,
      ...
      body: Column(
        children: [
          // Filter section
          Container(
            color: const Color(0xFF047857), // Darker corporate green
            child: Column(
              children: [
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                indicator: BoxDecoration(
                  color: const Color(0xFF059669), // Corporate green
                  borderRadius: BorderRadius.circular(25),
                ),
  ...
  Widget _buildPaginationButton(String text, bool enabled, VoidCallback onTap) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: enabled ? const Color(0xFF059669) : const Color(0xFFE5E7EB),
