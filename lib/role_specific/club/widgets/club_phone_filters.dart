...
/// ClubPhoneFilters: unified, phone-style filter section for Club screens
/// - Uses club blue background (#1E40AF)
/// - Mobile-friendly stacked layout
/// - Optional header toggle; can be embedded without header
class ClubPhoneFilters extends StatefulWidget {
  ...
  @override
  State<ClubPhoneFilters> createState() => _ClubPhoneFiltersState();
}

class _ClubPhoneFiltersState extends State<ClubPhoneFilters>
  ...
  Widget build(BuildContext context) {
    final Color bg = const Color(0xFF1E40AF);
