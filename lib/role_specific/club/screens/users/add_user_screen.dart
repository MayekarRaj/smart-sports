...
class _AddUserScreenState extends State<AddUserScreen>
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            Tab(text: 'Internal Users'),
            Tab(text: 'Privilege Users'),
          ],
        ),
      ),
      body: TabBarView(
        controller: _tabController,
        children: [_buildInternalUsersForm(), _buildPrivilegeUsersForm()],
      ),
    );
  }

  Widget _buildInternalUsersForm() {
  ...
  Widget _buildPrivilegeUsersForm() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
