...
class _ClubProfilePageState extends State<ClubProfilePage>
  ...
  final Color _roleColor = const Color(0xFF1E40AF); // Blue for Club

  // Form controllers
  final _firstNameController = TextEditingController(text: 'John');
  final _lastNameController = TextEditingController(text: 'Smith');
  final _passwordController = TextEditingController();
  final _addressLine1Controller = TextEditingController(text: '789 Sports Blvd');
  final _addressLine2Controller = TextEditingController(text: 'Building A');
  final _cityController = TextEditingController(text: 'Chicago');
  final _pincodeController = TextEditingController(text: '60601');
  final _companyNameController = TextEditingController(text: 'Premier Sports Club');
  final _designationController = TextEditingController(text: 'Club Manager');
  ...
  final _websiteController = TextEditingController(text: 'www.premiersports.com');

  String _selectedState = 'Illinois';
