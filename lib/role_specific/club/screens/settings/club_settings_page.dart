...
class _ClubSettingsPageState extends ConsumerState<ClubSettingsPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF3B82F6), // Club blue color
        elevation: 0,
        centerTitle: true,
        leading: Builder(
        ...
        builder: (context, constraints) {
          if (constraints.maxWidth < 768) {
            ...
            return Column(
              children: [
                Container(
                  color: const Color(0xFF3B82F6), // Club blue color
                  child: TabBar(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF3B82F6), // Club blue
  ...
  Widget _buildModuleCard(Map<String, dynamic> module, int webhookIndex, int moduleIndex) {
    return Container(
          ...
          Row(
            children: [
              ...
              IconButton(
                onPressed: () {
                  setState(() {
                    _slackWebhooks[webhookIndex]['modules'].removeAt(moduleIndex);
                  });
                },
