  ...
  Widget _buildFreeMembershipBenefits() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'With Free Member Membership, you get:',
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.w600,
              color: Colors.green,
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                _BenefitRow(text: 'Book available club slots'),
                _BenefitRow(text: 'View basic club/coach details'),
                _BenefitRow(text: 'Access open tournaments'),
              ],
            ),
          ),
          const SizedBox(height: 22),
          const Text(
            'With Free Member Membership, you will miss these extras (trial for * features)',
            style: TextStyle(
              fontSize: 14,
              color: Colors.red,
              fontWeight: FontWeight.w600,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Text(
              'Member Paid Membership Includes:',
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Colors.white,
                fontSize: 16,
          ...
          const SizedBox(height: 20),
          _BenefitRow(text: 'Priority booking privilege'),
          _BenefitRow(text: 'Discounts at participating clubs'),
          _BenefitRow(text: 'Direct club message & community join'),
          _BenefitRow(text: 'Access to premium tournaments'),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    final List<_MobileMissingService> missing = [
      _MobileMissingService(
        emoji: '🔒',
        name: 'Join restricted clubs',
        description: 'Unlock & participate in invite-only or premium clubs.',
        hasTrial: true,
      ),
      _MobileMissingService(
        emoji: '🏷️',
        name: 'Access exclusive discounts',
        description: 'Get promo deals and priority rates in privileged clubs.',
      ),
      _MobileMissingService(
        emoji: '💬',
        name: 'Comment/post in club feeds',
        description: 'Participate in discussions for matches, events, news.',
        hasTrial: true,
      ),
      _MobileMissingService(
        emoji: '🔔',
        ...
        description:
            'Receive direct push alerts about slot openings or club updates.',
        hasTrial: true,
      ),
    ];
    return Column(
